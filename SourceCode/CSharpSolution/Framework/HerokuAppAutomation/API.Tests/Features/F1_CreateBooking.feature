...
@API @CreateBooking
Scenario: Test Case 01 - Create Booking Postive scenario
...
@API @CreateBooking
Scenario: Test Case 02 - Create Booking Negative scenario Null Check
...
@API @CreateBooking
Scenario: Test Case 03 - Create Booking Negative scenario Invalid Date Check
